...
import 'edit_copy2_model.dart';
export 'edit_copy2_model.dart';

class EditCopy2Widget extends StatefulWidget {
  const EditCopy2Widget({
    super.key,
    required this.id,
  });
  ...
  @override
  State<EditCopy2Widget> createState() => _EditCopy2WidgetState();
}

class _EditCopy2WidgetState extends State<EditCopy2Widget> {
  late EditCopy2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditCopy2Model());
  }
            ...
            Padding(
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      'Você deseja apagar esse canteiro?',
